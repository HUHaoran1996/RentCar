...
$query="select * from rentcar where  license='$license'and address='$address'";
$rows=fetchAll($link, $query);
if($rows){
    foreach($rows as $rentcar){
        $_SESSION['license']=$rentcar['license'];
        $_SESSION['username']=$rentcar['username'];
        $_SESSION['mileage']=$rentcar['mileage'];
        $_SESSION['money']=$rentcar['money'];
        $_SESSION['abrasion']=$rentcar['abrasion'];
        $_SESSION['sdate']=$rentcar['sdate'];
        $_SESSION['edate']=$rentcar['edate'];
        $_SESSION['insurance']=$rentcar['insurance'];
        $_SESSION['totalmoney']=$rentcar['totalmoney'];
    }
}
else{
...
<div class="panel admin-panel">
  ...
  <div class="body-content">
   ...
   <tr>
      ...
      <a class="button border-main"href="CheckOutC.php" ><span class="icon-edit">Check Out</span> </a>
