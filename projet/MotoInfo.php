...
<div class="panel admin-panel">
  <div class="panel-head"><strong class="icon-reorder"> Moto's Information</strong></div>
  <div class="padding border-bottom">  
  <button type="button" class="button border-yellow" onclick="window.location.href='AddM.html'"><span class="icon-plus-square-o"></span> Add Moto</button>
  </div>
  <table class="table table-hover text-center">
   ...
   <tr>
      ...
      <th width="10%"><?php echo $moto['license']?></th>
      ...
      <form method="post" class="form-x" action="UpdateM.php">
      <button class="button border-main" name="update" value="<?php echo $moto['license']?>"> update</button> 
      </form> 
      <a class="button border-red" ><span class="icon-trash-o"data_id="<?php echo $moto['Id']?>">delete</span> </a>
      </div></th>
