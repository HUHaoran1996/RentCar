...
$link = connect3();
$query="select * from car where situation='yes'and abrasion not in('severe')";
...
<div class="panel admin-panel">
  <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>Available Cars</strong></div>
